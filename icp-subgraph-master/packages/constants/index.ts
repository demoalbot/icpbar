...
export const MASTER_CHEF_START_BLOCK = BigInt.fromI32(20897613)
...
export const MASTER_CHEF_ADDRESS = Address.fromString(
  '0x8e73456311edaf4027d32efb8dd1b2db014fa3be'
)
...
export const SUSHI_BAR_ADDRESS = Address.fromString(
  '0xe7946921c619f5d9e8f28e3a5b4d218e9520dd11'
)
...
export const SUSHI_TOKEN_ADDRESS = Address.fromString(
  '0xd63568e4bcb3d32c928e243e2bdb9e272d748a06'
)

export const SUSHI_USDT_PAIR_ADDRESS = Address.fromString(
  '0x5d8f1923643f822e2ce6634ad14f273276a78c30'
)
